                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <!-- Area of function-->
                                <div class="col-md-12">
                                    <button class="btn btn-warning" id="autoMatching">Auto Matching</button>
                                </div>
                                <!-- End Content of post -->
                            </div>
                        </div>
    ...
    $(document).ready(function() {
      ...
      $('#autoMatching').click(function(){
         ...
         for(var i = 0; i < arrNhan.length; i++){
             ...
             for(var indexSum = 0; indexSum < arrCho.length - 3; indexSum++){
