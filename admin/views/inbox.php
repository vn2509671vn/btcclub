                                    ...
                                    <table id="table-message" class="table table-striped table-bordered table-full-width" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php }else{?>
                                                ...
                                                <tr class="<?php if($mail['isread']){ echo "read"; }else {echo "unread";} ?>">
                                                    <td><?php echo $mail['nguoidung_hoten'];?></td>
                                                    <td><?php echo $mail['subject'];?></td>
                                                    <td><?php echo $mail['create_date'];?></td>
                                                    <td><a href="mail-detail-inbox.php?msgid=<?php echo $mail['messages_id'];?>" class="btn btn-info">READ</a></td>
                                                </tr>
                                                <?php }?>
                                            <?php }?>
                                        </tbody>
